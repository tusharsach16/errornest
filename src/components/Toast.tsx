...
export function Toast({ message, variant, onDismiss }: ToastProps) {
  ...
  const base =
    "fixed bottom-6 right-6 z-50 flex items-start gap-3 rounded-card px-4 py-3 shadow-lg ring-1 max-w-sm text-sm font-medium transition-opacity duration-[250ms]";
